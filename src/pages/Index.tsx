...
const schemaTables = [
  "users, sessions, devices, wallets, roles",
  "engagement_events, ad_completions, offerwall_conversions, game_matches, referrals",
  "reward_ledger, revenue_ledger, treasury_snapshots, reserve_buckets, payout_quotes",
  "withdrawal_requests, aml_flags, fraud_cases, risk_scores, moderation_actions",
            ...
            <Card className="rounded-[2rem] border-0 bg-[radial-gradient(circle_at_top_right,_rgba(124,58,237,0.22),_transparent_38%),linear-gradient(135deg,#1e1b4b,#312e81_45%,#0f172a)] text-white shadow-[0_30px_90px_rgba(49,46,129,0.32)]">
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <Badge className="rounded-full border-0 bg-white/15 px-3 py-1 text-white">Live treasury logic</Badge>
            ...
            <div className="grid gap-5 lg:grid-cols-[1.05fr_0.95fr]">
              ...
              <div className="space-y-5">
                ...
                <Card className="rounded-[2rem] border-0 bg-[linear-gradient(180deg,#eef2ff,#ffffff)] shadow-[0_18px_60px_rgba(15,23,42,0.08)]">
                  ...
                  <CardContent className="space-y-3 text-sm leading-7 text-slate-600">
                    <p>JWT auth, refresh token rotation, Argon2 hashing, encrypted secrets, immutable audits, RBAC, WAF, and DDoS mitigation are baseline controls.</p>
